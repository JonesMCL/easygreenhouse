var chartObject = document.getElementById('chartAirTemp');

var chartAirTemp = new Chart(chartObject, {
    type: 'line',
    data: {
...
axios.get("http://0.0.0.0:4000/api/sensordataHistory/getAverageAirtempMonthly").then(
    async (response) => {
        ...
        removeData(chartAirTemp)
        addData(chartAirTemp, data)
    }
);  
